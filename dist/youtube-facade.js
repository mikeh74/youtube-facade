...
})({"4S2kq":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "87d534469b545b1a";
"use strict";
...
},{}],"kMdZw":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _facade = require("./facade");
var _facadeDefault = parcelHelpers.interopDefault(_facade);
window.youtubeFacade = (0, _facadeDefault.default);

},{"./facade":"3l3Wv","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3l3Wv":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
 ...
 */ function renderYoutubePlayer(el, videoId, playerVars) {
    ...
    let target = (0, _utils.getTargetElement)(el);
    if (!target) {
    ...
    (0, _loader.createYouTubePlayer)(target, videoId, playerVars).then((player)=>{
...
const modalTemplate = (()=>{
    ...
    return {
        get: ()=>template,
        set: (newTemplate)=>{
            if (typeof newTemplate === 'string') template = newTemplate;
        }
    };
})();
...
const toggleModal = ()=>{
    ...
    if (modal.classList.contains('youtube-facade-modal-active')) document.body.classList.add('youtube-facade-body-no-scroll');
    else document.body.classList.remove('youtube-facade-body-no-scroll');
};
/**
 ...
 */ const youtubeFacade = ({ selector = '.youtube-facade', muteForAutoplay = true, customModalTemplate = null } = {})=>{
    // Set the modal template if provided
    if (customModalTemplate && typeof customModalTemplate === 'string') modalTemplate.set(customModalTemplate);
 ...
 */ function handleVideoClick(el, playerVars) {
    ...
    if (needsYTApi) renderYoutubePlayer(el, videoId, playerVars);
    else renderYouTubeIframe(el, videoId, playerVars);
...
function getTargetElement(el) {
    ...
    if (targetSelector) {
        ...
        console.error('getTargetElement: Target element not found for selector:', targetSelector);
        return null;
    }
    return el;
}
...
},{}],"1Ef8k":[function(require,module,exports,__globalThis) {
// ------ YouTube Iframe API ------
// The API will call this function when the video player is ready.
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "createYouTubePlayer", ()=>createYouTubePlayer);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["4S2kq","kMdZw"], "kMdZw", "parcelRequire94c2")
